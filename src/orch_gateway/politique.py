...
Outils de l'upstream orch-mcp (agent orchestrator, 19 outils : 14 jobs/missions + 2 alertes infra read-only + 3 questions). Lancer/annuler un agent ou répondre à une question = ecriture.
"""
